...
Route::group(['prefix' => 'auth'], function () {
    ...
    Route::get('register', [\App\Http\Controllers\Auth\Register::class, 'create'])->name('register');
    Route::post('register', [\App\Http\Controllers\Auth\Register::class, 'store'])->name('register.store');
});
